      ...
      <div className="container">
        <div className="flex flex-col items-center max-w-2xl mx-auto">
          ...
          <div className="flex items-center h-11 w-full mb-10">
            <input className='w-full h-full pl-4 rounded-tl-full rounded-bl-full dark:bg-very-dark-gray dark:text-white dark:hover:bg-black transition-mode border border-solid border-spanish-gray' type="text" placeholder='Your email address' />
